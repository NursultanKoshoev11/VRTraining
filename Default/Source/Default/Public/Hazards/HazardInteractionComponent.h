...
class DEFAULT_API UHazardInteractionComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	bool MarkHazardFound(const FString& Action = TEXT("marked_hazard"));

	UFUNCTION(BlueprintCallable, Category = "Hazard")
	bool RecordUnsafeTrainingAction(const FString& Action = TEXT("unsafe_action"));
